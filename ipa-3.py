...
def relationship_status(from_member, to_member, social_graph):
    ...
    following_of_from_member = social_graph[str(from_member)]["following"]
    following_of_to_member = social_graph[str(to_member)]["following"]
    
    if (str(to_member) in following_of_from_member) and (str(from_member) in following_of_to_member):
        return "friends"

    elif str(from_member) in following_of_to_member:
        return "followed by"

    elif str(to_member) in following_of_from_member:
        return "follower"
